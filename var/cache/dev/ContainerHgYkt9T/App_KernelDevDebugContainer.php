...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\EventCategoryController' => 'getEventCategoryControllerService',
            ...
            'App\\Controller\\MonthlyController' => 'getMonthlyControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Ul8KChQS6a', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8FCOgPPSxp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v3G7bHJJF1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = ($this->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => 'C:\\Fichame2\\src\\Entity', 1 => 'C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src\\Entity']));
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\EventCategoryRepository' => ['privates', 'App\\Repository\\EventCategoryRepository', 'getEventCategoryRepositoryService', true],
            ...
            'App\\Repository\\EventCategoryRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VXTTenVOE6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Cn0bWl9mY-', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uNqMV0lgo9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4ixOFTnq3w', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('77j6ydCwW7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RodVBtBZbk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($this->getEnv('default::SYMFONY_IDE'), ($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\Fichame2', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] function () {
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf'], 'az' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf'], 'cs' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf'], 'cy' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf'], 'el' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf'], 'es' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf'], 'et' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf'], 'fr' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf'], 'gl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf'], 'hy' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf'], 'it' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf'], 'ja' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf'], 'lb' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf'], 'nn' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf'], 'pt' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf'], 'pt_BR' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf'], 'ru' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf'], 'sk' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf'], 'sl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf'], 'uk' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf'], 'ur' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf']], 'scanned_directories' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations', 3 => 'C:\\Fichame2/translations', 4 => 'C:\\Fichame2\\vendor\\symfony\\framework-bundle/translations', 5 => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'C:\\Fichame2\\vendor\\symfony\\maker-bundle\\src/translations', 8 => 'C:\\Fichame2\\vendor\\symfony\\security-bundle/translations', 9 => 'C:\\Fichame2\\vendor\\symfony\\debug-bundle/translations', 10 => 'C:\\Fichame2\\vendor\\symfony\\twig-bundle/translations', 11 => 'C:\\Fichame2\\vendor\\symfony\\web-profiler-bundle/translations', 12 => 'C:\\Fichame2\\vendor\\twig\\extra-bundle/translations', 13 => 'C:\\Fichame2\\vendor\\symfony\\monolog-bundle/translations', 14 => 'C:\\Fichame2\\vendor\\sensio\\framework-extra-bundle\\src/translations', 15 => 'C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'C:\\Fichame2\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\Fichame2\\vendor\\symfony\\security-core/Resources/translations', 3 => 'translations', 4 => 'C:\\Fichame2\\vendor\\symfony\\framework-bundle/translations', 5 => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-bundle/translations', 6 => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 7 => 'C:\\Fichame2\\vendor\\symfony\\maker-bundle\\src/translations', 8 => 'C:\\Fichame2\\vendor\\symfony\\security-bundle/translations', 9 => 'C:\\Fichame2\\vendor\\symfony\\debug-bundle/translations', 10 => 'C:\\Fichame2\\vendor\\symfony\\twig-bundle/translations', 11 => 'C:\\Fichame2\\vendor\\symfony\\web-profiler-bundle/translations', 12 => 'C:\\Fichame2\\vendor\\twig\\extra-bundle/translations', 13 => 'C:\\Fichame2\\vendor\\symfony\\monolog-bundle/translations', 14 => 'C:\\Fichame2\\vendor\\sensio\\framework-extra-bundle\\src/translations', 15 => 'C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\Fichame2');
        $a->addPath('C:\\Fichame2\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\Fichame2\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\Fichame2\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('C:\\Fichame2\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src/Resources/views', 'Calendar');
        $a->addPath('C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src/Resources/views', '!Calendar');
        $a->addPath('C:\\Fichame2/templates');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\Fichame2\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($g, 'C:\\Fichame2', 'UTF-8'));
        ...
        $instance->addGlobal('font_awesome', 'https://kit.fontawesome.com/ba93e0a9d0.js');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'C:\\Fichame2\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return $this->privates['var_dumper.server_connection'] = new \Symfony\Component\VarDumper\Server\Connection('tcp://'.$this->getEnv('string:VAR_DUMPER_SERVER'), ['source' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\SourceContextProvider('UTF-8', 'C:\\Fichame2', ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService())), 'request' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\RequestContextProvider(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack())), 'cli' => new \Symfony\Component\VarDumper\Dumper\ContextProvider\CliContextProvider()]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'CalendarBundle' => [
                    'path' => 'C:\\Fichame2\\vendor\\tattali\\calendar-bundle\\src',
            ...
            'translator.default_path' => 'C:\\Fichame2/translations',
            ...
            'twig.default_path' => 'C:\\Fichame2/templates',
